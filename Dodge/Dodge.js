...
angleMode(DEGREES);
img = loadImage('data/terra.jpg');
bola = loadImage('data/Tentativan4.png');
m = loadImage('data/missile_2.png');
start = loadImage ('data/sla.jpg');
star = loadImage('data/estrela.gif');
stars = loadImage('data/giphy.gif');
stars2 = loadImage('data/giphy2.gif');
...
function draw() {
 if(norma === 4){
   ...
   textStyle(ITALIC);
   text("D", 700 , height / 4);
   text("DGE",1150,height / 4);
   textSize(100);
   fill(247,150,2);
   text("The Game",width / 2 + 25, height / 2.7 );
   textSize(100);
   textStyle(NORMAL);
   fill(234,133,218);
   text('Press         to play!', 1000, height / 1.5);
   textSize(95);
   fill(91,232,61);
   text('enter', 964, height / 1.5);
   rotate(-117);
   image(star,-950,510,800,800);
...
strokeWeight(3);
fill (255);
image(bola,rightwall,y2,100,100);
...
image(m,x,y,100,100);
 ...
 if(sla === 1){
   image(stars2, 100,100,1500,1000);
   frameRate(100);
   scorenumbnumb = 0;
   background(start);
   xspeed = 0;
   ...
   image(bola,width / 2.15 + 60,225,170,170);
   fill(234,133,218);
   textSize(80);
   text("Press       to restart", 940,660);
   fill(0,255,0);
   text("F5",885,660);
   arrowspeed = 0;
   fill(255,255,0);
 ...
 if(sla == 1 && scorenumb>=51  && scorenumb <= 75){
   ...
   textSize(50);
   strokeWeight(5);
   text("You are: Legendary",940,1000);
   } 
  ...
  if(sla == 1 && scorenumb>=101  && scorenumb <= 500){
   ...
   textSize(50);
   strokeWeight(5);
   text("Are you even human?",940,1000);
   } 
 ...
 if(sla == 1 && scorenumb>=500 && scorenumb <= 1000){
   ...
   textSize(50);
   strokeWeight(5);
   text("What's even the point?",940,1000);
   } 
  ...
  if(sla == 1 && scorenummb<1001){
   ...
   textSize(50);
   strokeWeight(5);
   text("You can rest in peace now",940,1000);
   } 
